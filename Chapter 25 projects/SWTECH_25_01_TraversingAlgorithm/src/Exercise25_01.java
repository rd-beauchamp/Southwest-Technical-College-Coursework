...
public class Exercise25_01 {
  ...
  public class BinaryTree<E extends Comparable<E>> extends AbstractTree<E> {
     ...
     */
    public int height() { //added on 11/29/2023 by R.Beauchamp
      if (root == null) {
    	  return 0;
      }else{
    	return root.height();
     ...
     */
    public void breadthFirstTraversal() { //added 11/29/2023 by R.Beauchamp
    ...
    public class TreeNode<E extends Comparable<E>> {
      ...
      public int height() {							//added on 11/29/2023 by R.Beauchamp
    	  int leftBig = 0, rightBig = 0;
    	  if(this.left != null)
    		  leftBig = (this.left.height());
    	  
    	  if(this.right!= null)
    		  rightBig = this.right.height();
    	        
    	  	return 1 + Math.max(leftBig, rightBig);
      }
    }
